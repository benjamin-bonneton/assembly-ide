...
export const functions = {
  ...
  ADD: {
    category: 'operations',
    description: 'Add rA and rB, store in rC. Set flags',
    usage: 'ADD <rA> <rB> <rC>',
  ...
  SUB: {
    category: 'operations',
    description: 'Subtract rB from rA, store in rC. Set flags',
    usage: 'SUB <rA> <rB> <rC>',
    args: [['register'], ['register'], ['register']],
    options: [],
  },
  NOR: {
    category: 'operations',
    description: 'Bitwise NOR of rA and rB, store in rC. Set flags',
    usage: 'NOR <rA> <rB> <rC>',
    args: [['register'], ['register'], ['register']],
    options: [],
  },
  AND: {
    category: 'operations',
    description: 'Bitwise AND of rA and rB, store in rC. Set flags',
    usage: 'AND <rA> <rB> <rC>',
    args: [['register'], ['register'], ['register']],
    options: [],
  },
  XOR: {
    category: 'operations',
    description: 'Bitwise XOR of rA and rB, store in rC. Set flags',
    usage: 'XOR <rA> <rB> <rC>',
    args: [['register'], ['register'], ['register']],
    options: [],
  },
  RSH: {
    category: 'operations',
    description: 'Right shift rA, store in rB. Set flags',
    usage: 'RSH <rA> <rB>',
  ...
  ADI: {
    category: 'memory',
    description: 'Add immediate value to rA, store in rA. Set flags',
    usage: 'ADI <rA> <value>',
    args: [['register'], ['immediate']],
    options: [],
  },
